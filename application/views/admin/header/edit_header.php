...
<div class="container">
	...
	<?= form_open_multipart("header/update_header_data/{$header_data->id}", 'class="form-horizontal"'); ?> 
		  ...
		  <fieldset>
			<legend>Change Header Setting</legend>
			<div class="row">
				<div class="form-group">
					<label for="inputEmail" class="col-lg-2 control-label">Title :</label>
					<div class="col-lg-6">
					<?= form_input( ['name'=>'title', 'class'=>'form-control', 'id'=>'inputEmail', 'placeholder'=>'Enter Title', 'value'=>set_value('title', $header_data->title)])?>
					</div>
				</div>
				<div class="col-lg-6">
